...
num_hand = 1
#mediapipe手部姿势估计器
base_options = python.BaseOptions(model_asset_path='{}/hand_landmarker.task'.format(os.path.dirname(os.path.abspath(__file__))), delegate=python.BaseOptions.Delegate.GPU)
