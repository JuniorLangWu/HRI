...
class Graph:
    ...
    def __init__(self,
        ...
        assert layout in ['openpose', 'nturgb+d', 'coco', 'handmp', 'rtmpose', 'posehand']
    ...
    def get_layout(self, layout):
        if layout == 'openpose':
            ...
            self.center = 0
        elif layout == 'posehand':
            self.num_node = 51
            self.inward = [
                (7, 5), (8, 6), (5, 0), (6, 0),
                (1, 0), (3, 1), (2, 0), (4, 2),
                #右手
                (10,9), (11, 10), (12, 11), (13, 12), (14, 9), (15, 14), (16, 15), (17, 16),
                (18, 9), (19, 18), (20, 19), (21, 20), (22, 9), (23, 22),
                (24, 23), (25, 24), (26, 9), (27, 26), (28, 27), (29, 28),

                (31, 30), (32, 31), (33, 32), (34, 33), (35, 30), (36, 35), (37, 36), (38, 37),
                (39, 30), (40, 39), (41, 40), (42, 41), (43, 30), (44, 43),
                (45, 44), (46, 45), (47, 30), (48, 47), (49, 48), (50, 49)
            ]
            self.center = 6 - 5
        else:
